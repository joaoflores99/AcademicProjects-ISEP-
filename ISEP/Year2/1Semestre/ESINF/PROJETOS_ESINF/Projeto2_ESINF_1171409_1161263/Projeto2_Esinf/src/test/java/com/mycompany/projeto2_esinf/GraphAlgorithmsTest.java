 ...
 @Test
    ...
    */
	...
	double lenpath=0;
        ...
        assertTrue("Length path should be 0 if vertex does not exist", lenpath == -1);
	
        lenpath=GraphAlgorithms.shortestPath(incompleteMap,"Porto","Faro",shortPath);
	assertTrue("Length path should be 0 if there is no path", lenpath == -1);
    ...
    */
    ...
    LinkedList<String> shortPath = new LinkedList<String>();
    double lenpath=0;
        lenpath=GraphAlgorithms.shortestPathEstacoes(completeMap,"Porto","LX",shortPath);
        assertTrue("Length path should be 0 if vertex does not exist", lenpath == 0);
   
        lenpath=GraphAlgorithms.shortestPathEstacoes(incompleteMap,"Porto","Faro",shortPath);
    assertTrue("Length path should be 0 if there is no path", lenpath == 0);
       
        lenpath=GraphAlgorithms.shortestPathEstacoes(completeMap,"Porto","Porto",shortPath);
        assertTrue("Number of nodes should be 1 if source and vertex are the same", shortPath.size() == 1);
       
    lenpath=GraphAlgorithms.shortestPathEstacoes(incompleteMap,"Porto","Lisboa",shortPath);
        assertTrue("Path between Porto and Lisboa should be 335 Km", lenpath == 4);
    ...
    lenpath=GraphAlgorithms.shortestPathEstacoes(incompleteMap,"Braga","Leiria",shortPath);
        assertTrue("Path between Braga and Leiria should be 255 Km", lenpath == 4);
        ...
        shortPath.clear();
        lenpath=GraphAlgorithms.shortestPathEstacoes(completeMap,"Porto","Castelo Branco",shortPath);  
    assertTrue("Path between Porto and Castelo Branco should be 335 Km", lenpath == 4);
    assertTrue("N. cities between Porto and Castelo Branco should be 5 ", shortPath.size() == 4);
 
        it = shortPath.iterator();
 
        assertTrue("First in path should be Porto", it.next().compareTo("Porto")==0);
        assertTrue("then Aveiro", it.next().compareTo("Aveiro")==0);
        assertTrue("then Viseu", it.next().compareTo("Leiria")==0);
        //assertTrue("then Guarda", it.next().compareTo("Guarda")==0);
        //assertTrue("then Castelo Branco", it.next().compareTo("Castelo Branco")==0);
    ...
    shortPath.clear();
        lenpath=GraphAlgorithms.shortestPathEstacoes(completeMap,"Porto","Castelo Branco",shortPath);
        assertTrue("Path between Porto and Castelo Branco should now be 365 Km", lenpath == 4);
        assertTrue("Path between Porto and Castelo Branco should be 4 cities", shortPath.size() == 4);
