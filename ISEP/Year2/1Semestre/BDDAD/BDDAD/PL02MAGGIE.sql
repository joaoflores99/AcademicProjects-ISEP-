...
--7
SELECT * FROM equipas, treinadores, experiencias WHERE treinadores.id_treinador = experiencias.id_treinador AND experiencias.id_equipa = equipas.id_equipa AND equipas.nome = 'Académico';
--8
SELECT MAX(treinadores.idade) FROM treinadores, equipas, experiencias WHERE treinadores.id_treinador = experiencias.id_treinador AND experiencias.id_equipa = equipas.id_equipa AND equipas.nome = 'Académico';
--9
SELECT SUM(experiencias.anos) FROM experiencias, equipas, treinadores WHERE treinadores.id_treinador = experiencias.id_treinador AND experiencias.id_equipa = equipas.id_equipa AND equipas.nome = 'Académico' AND treinadores.nome = 'António';
