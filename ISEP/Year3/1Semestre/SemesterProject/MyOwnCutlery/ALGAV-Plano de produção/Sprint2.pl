...
gera_geracao(N,G,Pop,ValorCriterio,ValorIncremental):-
	...
	random_permutation(Pop,NovaReordenacao), %reordena a lista das populacao para preparar para um soluçao mais random
	...
	append(NPopAv,NovaReordenacao,GeracaoNovaComAntiga), %juntamos as duas gerações de seguida removemos repetidos e escolhemos os 2 melhores
